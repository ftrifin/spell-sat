...
"""
PACKAGE 
    server.context.execoperations 
FILE
    execoperations.py
    
DESCRIPTION
    Implementation of all executor requests
...
class EXCOperations(object):
    ...
    def request_OpenExecutor(self, msg):
        ...
        if procId is None:
            ...
            # Obtain an available instance number for the subprocedure
            sprocId = self.context.getInstanceId(sprocId)
