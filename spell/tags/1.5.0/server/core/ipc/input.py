...
"""
PACKAGE 
    server.core.ipc.input
FILE
    input.py
    
DESCRIPTION
    Base class of all input interfaces (reading from peer)
...
class IPCinput(IPCworker):
    ...
    def dispatch(self, msg):
        ...
        try:
            ...
            if tp in [MSG_TYPE_RESPONSE,MSG_TYPE_ERROR]:
            ...
            elif tp in [MSG_TYPE_COMMAND,MSG_TYPE_WRITE]:
