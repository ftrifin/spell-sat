...
//=============================================================================
SPELLwsDataHandler::SPELLwsDataHandler( SPELLwsDataCode code )
: m_storage(NULL),
  m_dataCode(code)
{
...
//=============================================================================
SPELLwsDataCode SPELLwsDataHandler::getCode() const
{
	return m_dataCode;
};
...
//=============================================================================
SPELLwsDataCode SPELLwsDataHandler::loadDataCode()
{
	return static_cast<SPELLwsDataCode>(getStorage()->loadLong());
}
...
//=============================================================================
void SPELLwsDataHandler::setCode( SPELLwsDataCode code )
{
	m_dataCode = code;
};
