...
//=============================================================================
void SPELLstandaloneCif::setup( const std::string& procId, const std::string& ctxName, int ctxPort, const std::string& timeId)
{
...
{
    m_shell->show_status( StatusToString(st.status) + " (" + st.condition + ")" );
}
...
//=============================================================================
std::string SPELLstandaloneCif::prompt( const std::string& message, PromptOptions options, unsigned int type, unsigned int scope )
{
