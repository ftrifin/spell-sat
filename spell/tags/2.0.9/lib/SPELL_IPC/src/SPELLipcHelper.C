...
//=============================================================================
SPELLipcMessage* SPELLipcHelper::createResponse( std::string id, SPELLipcMessage* request )
{
    SPELLipcMessage* response = new SPELLipcMessage( id );
...
//=============================================================================
SPELLipcMessage* SPELLipcHelper::createErrorResponse( std::string id, SPELLipcMessage* request )
{
    SPELLipcMessage* response = new SPELLipcMessage( id );
