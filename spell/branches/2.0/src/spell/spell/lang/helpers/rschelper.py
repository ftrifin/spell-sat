...
class SetResource_Helper(WrapperHelper):
    ...
    def _doOperation(self, *args, **kargs ):
        ...
        def _doRepeat(self):
            ...
            self._write("Retry set resource value " + repr(self.__parameter), {Severity:WARNING} )
            return [True, None]
    
        #===========================================================================
        def _doSkip(self):
            self._notifyValue( repr(self.__parameter), "???", NOTIF_STATUS_SP, " ")
            self._write("Skip set resource value " + repr(self.__parameter), {Severity:WARNING} )
            return [False, None]

        #===========================================================================
        def _doCancel(self):
            self._notifyValue( repr(self.__parameter), "???", NOTIF_STATUS_SP, " ")
            self._write("Cancel set resource value " + repr(self.__parameter), {Severity:WARNING} )
            return [False, None]
...
class GetResource_Helper(WrapperHelper):
    ...
    def _doOperation(self, *args, **kargs ):
        ...
        def _doCancel(self):
            self._notifyValue( repr(self.__parameter), "???", NOTIF_STATUS_SP, " ")
            self._write("Cancel get resource value " + repr(self.__parameter), {Severity:WARNING} )
            return [False, None]
