...
set DEV_RCP_CONFIG=%DEV_HOME%\bin\configuration\win32
...
:runit
java -jar "%LAUNCHER%" -showsplash "%DEV_HOME%\bin\splash.bmp" -configuration "%DEV_RCP_CONFIG%" -os win32 -arch x86 -ws win32 -clean -consoleLog -vm "%JRE_HOME%\bin\client\jvm.dll" 
