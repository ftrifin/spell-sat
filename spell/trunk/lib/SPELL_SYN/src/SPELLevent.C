...
void SPELLevent::set()
{
	if (m_log) std::cerr << "SET EVENT IN " << (void*) this << std::endl;
...
{
	if (m_log) std::cerr << "WAIT EVENT IN " << (void*) this << std::endl;
	...
	if (m_log) std::cerr << "WAIT EVENT OUT" << (void*) this << std::endl;
}
