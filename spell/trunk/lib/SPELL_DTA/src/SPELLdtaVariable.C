...
{
	if (PyDict_Contains(kwds, SSTRPY(LanguageModifiers::Default) ))
	{
...
{
	m_expected.clear();
	if (PyDict_Contains(kwds, SSTRPY(LanguageModifiers::Expected) ))
	{
		// Borrowed reference
...
{
	m_range.clear();;
	if (PyDict_Contains(kwds, SSTRPY(LanguageModifiers::Range) ))
	{
		// Borrowed reference
...
{
	if (PyDict_Contains(kwds, SSTRPY(LanguageModifiers::Type) ))
	{
		// Borrowed reference
...
{
	if (PyDict_Contains(kwds, SSTRPY(LanguageModifiers::ValueFormat) ))
	{
		// Borrowed reference
...
{
	if (PyDict_Contains(kwds, SSTRPY(LanguageModifiers::Confirm) ))
	{
		// Borrowed reference
