...
{
	LOG_WARN("Clear previous errors");
...
//============================================================================
// METHOD: SPELLerror::executionAborted()
//============================================================================
void SPELLerror::executionAborted()
{
	...
	if ( m_ctrlExceptionSet == EXC_NONE )
	{
		...
		clearErrors();
		SPELLsafePythonOperations ops("SPELLerror::executionAborted");
		PyErr_SetObject( m_excExecutionAborted, m_excExecutionAborted );
	...
	{
		DEBUG("[ERR] Cannot set execution aborted, already set to " + ISTR(m_ctrlExceptionSet));
	}
}

//============================================================================
// METHOD: SPELLerror::executionTerminated()
//============================================================================
void SPELLerror::executionTerminated()
{
	...
	if ( m_ctrlExceptionSet == EXC_NONE )
	{
		...
		PyErr_SetObject( m_excExecutionTerminated, m_excExecutionTerminated );
...
//============================================================================
bool SPELLerror::isExecutionAborted( PyObject* exc )
{
...
// METHOD: SPELLerror::isExecutionAborted()
//============================================================================
bool SPELLerror::isExecutionTerminated( PyObject* exc )
{
