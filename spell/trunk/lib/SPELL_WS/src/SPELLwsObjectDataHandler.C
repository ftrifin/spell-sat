...
: SPELLwsDataHandler( DATA_GENERIC )
{
	setObject(object);
}
...
//=============================================================================
void SPELLwsObjectDataHandler::storeFakeObject( SPELLwsDataCode code )
{
	switch(code)
	{
	case DATA_BYTECODE:
	...
	case DATA_LIST:
		...
		break;
	default:
		throw SPELLcoreException("Cannot store fake object", "Unknown handler type: " + ISTR(code));
	}
}
